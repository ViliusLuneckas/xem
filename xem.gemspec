...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["LICENSE.txt", "README", "README.rdoc", "lib/xem.rb"]
  s.files = ["LICENSE.txt", "README", "README.rdoc", "Rakefile", "lib/xem.rb", "spec/spec_helper.rb", "spec/xem_spec.rb", "Manifest", "xem.gemspec"]
