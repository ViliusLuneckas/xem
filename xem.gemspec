...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["LICENSE.txt", "README", "README.rdoc", "lib/xem.rb", "lib/xem/cache.rb", "lib/xem/camera.rb", "lib/xem/console.rb", "lib/xem/constants.rb", "lib/xem/font_manager.rb", "lib/xem/helpers.rb", "lib/xem/keyboard.rb", "lib/xem/metrics.rb", "lib/xem/mouse.rb", "lib/xem/point.rb", "lib/xem/settings.rb", "lib/xem/simple_draw.rb", "lib/xem/version.rb", "lib/xem/xem.rb"]
  s.files = ["LICENSE.txt", "README", "README.rdoc", "Rakefile", "examples/data/fonts/simple.tga", "examples/movement.rb", "examples/simple.rb", "examples/using_cache.rb", "examples/using_integrated_console.rb", "lib/xem.rb", "lib/xem/cache.rb", "lib/xem/camera.rb", "lib/xem/console.rb", "lib/xem/constants.rb", "lib/xem/font_manager.rb", "lib/xem/helpers.rb", "lib/xem/keyboard.rb", "lib/xem/metrics.rb", "lib/xem/mouse.rb", "lib/xem/point.rb", "lib/xem/settings.rb", "lib/xem/simple_draw.rb", "lib/xem/version.rb", "lib/xem/xem.rb", "spec/spec_helper.rb", "spec/xem/font_manager_spec.rb", "spec/xem/helpers_spec.rb", "spec/xem_spec.rb", "xem.gemspec", "Manifest"]
